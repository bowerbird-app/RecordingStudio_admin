...
module RecordingStudioAdmin
  module Resolvers
    class ScreenResolver
      ...
      def resolve_screen_widget(screen_definition, widget_usage)
        ...
        apply_usage_overrides(screen_definition, widget_usage, widget_context, widget)
      end

      def resolve_screen_widgets(definition)
        definition.widget_usages.filter_map do |widget_usage|
          if @resolve_widgets
            resolve_screen_widget(definition, widget_usage)
          else
      ...
      def placeholder_widget(screen_definition, widget_usage)
        widget_definition = RecordingStudioAdmin.widget_for(widget_usage.key)
        return unless widget_definition
      ...
      def apply_usage_overrides(definition, widget_usage, widget_context, widget)
        overrides = {
          view_variant: widget_usage.view_variant,
