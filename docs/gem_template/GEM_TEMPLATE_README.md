...
- [ADMIN_SCREENS.md](ADMIN_SCREENS.md): how screens, sections, and widgets are defined and registered
- [INSTALLING.md](INSTALLING.md): host-app installation and generator behavior
- [CONFIGURATION.md](CONFIGURATION.md): authentication, actor, access-recording, and route helper configuration
